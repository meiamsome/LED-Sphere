...
GCC_BIN = 
PROJECT = LED_Sphere
OBJECTS = ./main.o ./BAI.o ./LEDController.o ./utils.o ./ExampleAnimation.o ./RemoteAnimation.o
...
CC_FLAGS += -MMD -MP
CC_SYMBOLS = -DTARGET_LPC1768 -DTARGET_M3 -DTARGET_CORTEX_M -DTARGET_NXP -DTARGET_LPC176X -DTARGET_MBED_LPC1768 -DTOOLCHAIN_GCC_ARM -DTOOLCHAIN_GCC -D__CORTEX_M3 -DARM_MATH_CM3 -DMBED_BUILD_TIMESTAMP=1422390066.38 -D__MBED__=1 
